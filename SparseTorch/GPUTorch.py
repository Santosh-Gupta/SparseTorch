...
class GPUSparseModelFactory(_GPUSparseCommon):
...
class GPUGeneralOptimizerFactory(_GPUSparseCommon): #to do later, able to load matrixes to continue training
...
class GPUSparseCOM(_GPUSparseCommon):
